...
<html lang="en">
  <head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="stylesheet" href="/css/styles.css">
    ...
    <title>Virtual Lolly for all!</title>
  </head>
  <body>
    <div class="container">
      ...
      <div class="lolly">
        ...
        <div class="info">
          <p class="share">Your Lolly is freezing. Share it with this link: <pre>https://vlolly.net/${data.lollyPath}</pre></p>
          <div class="details">
            <p id="recipient" class="recipient">${data.recipientName}</p>
            <div id="message" class="message">${data.message}</div>
            <p id="from" class="from">— ${data.senderName}</p>
          </div>
          <p class="bytheway">${data.senderName} made this virtual lolly for you. You can <a href="/create">make your own</a> to send to a friend who deserve some sugary treat which won't rot their teeth...</p>
        </div>
      </div>
      <footer>
        <p>
